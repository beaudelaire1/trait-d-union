...
from .views import (
    ...
    SimulateurView, simulateur_increment, simulateur_pdf,
)
...
urlpatterns = [
    ...
    path('simulateur/increment/', simulateur_increment, name='simulateur_increment'),
    path('simulateur/pdf/', simulateur_pdf, name='simulateur_pdf'),
]