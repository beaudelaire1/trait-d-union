    ...
    def handle(self, *args, **options):
        ...
        defaults = dict(
            ...
            result=(
                ...
                "<li><strong>L'accessibilité est une porte, pas une intention.</strong> "
                "Avant chaque mise en production, six pages — accueil, formations, "
                "candidature, connexion, bibliothèque, e-learning — sont mesurées "
                "trois fois. Un seul audit d'accessibilité ou de bonnes pratiques "
                "en échec bloque la livraison : le seuil est le score parfait, pas "
                "« au-dessus de 90 », et le rapport nomme l'audit fautif plutôt "
                "que d'accepter une moyenne. Même porte sur la vitesse ressentie : "
                "LCP médian sous 2,5 s, CLS maximum sous 0,10.</li>"
                "<li><strong>Un champ de formulaire sans nom accessible fait "
                "échouer la suite</strong> — un test balaie les 206 gabarits, "
                "back-office compris. Un &lt;input&gt; sans étiquette n'affiche "
                "aucune erreur : il s'annonce simplement « zone d'édition, vide » "
                "à un lecteur d'écran, et rien ne le signale. Un scan OWASP ZAP "
                "complète le dispositif à chaque pré-déploiement, où toute alerte "
                "nouvelle interrompt la livraison.</li>"
