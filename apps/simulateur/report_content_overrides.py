...
_ATERRISSAGE = {
    ...
    'questions': [
        (
            "Les taux de conversion appliqués au pipeline sont-ils fondés sur "
            "l'historique réel ou sur une hypothèse optimiste ?"
        ),
        (
            "Quels services ou produits portent l'écart à l'objectif, et quelle "
            "cadence mensuelle faudrait-il tenir pour le résorber ?"
        ),
        (
            "Une fois la marge, les RFA et les PPTG intégrés, la trajectoire "
            "reste-t-elle économiquement satisfaisante ?"
        ),
    ],
    'next_steps': [
        (
            "Rapprochez le CA réalisé avec la comptabilité ou la facturation "
            "avant de figer la projection."
        ),
        (
            "Nettoyez le pipeline : retirez les opportunités perdues, doublons "
            "et montants insuffisamment qualifiés."
        ),
        (
            "Calibrez le taux de conversion de chaque service sur vos données "
            "historiques plutôt que sur un taux unique par défaut."
        ),
        (
            "Testez au moins trois scénarios — prudent, central et haut — pour "
            "mesurer la sensibilité de l'atterrissage."
        ),
        (
            "Transformez l'écart restant en objectif mensuel par service et "
            "suivez-le à fréquence régulière jusqu'à la clôture."
        ),
    ],
    'framework': (
